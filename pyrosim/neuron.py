...
class NEURON: 
    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses): # do I add self. ifront of neurons and synapses?
        self.Set_Value(0)
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight, value):
        self.multipliedVal = weight*value
        self.Add_To_Value(self.multipliedVal)
